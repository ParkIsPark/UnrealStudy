...
**Study context:**
- Instructor-led study group running from March 2026 (10-week schedule)
- Current progress: Weeks 1–3 complete (theory-heavy; practical sessions starting Week 4)
...
│   └── 강의_계획_수정본.md  # Revised syllabus (Weeks 1–9)
└── Week3.uproject         # UE5.4 project descriptor
```
...
| 5 | 5/4 | UMG/Widget Blueprints, HUD, Blueprint basics | 🔲 |
| 6 | 5/11 | UE C++ deep: GC, Reflection, Coding conventions | 🔲 |
| 7 | 5/18 | Delegates, Component-based design | 🔲 |
| 8 | 5/25 | Asset management + Data-driven design | 🔲 |
| 9 | 6/1 | Capstone practical & wrap-up | 🔲 |

**Topics not yet covered:** PlayerState, PlayerController details, UI, inter-object communication, scalable architecture, game scope expansion.

## Course Materials

All study documents live in `course_materials/`:
- `강의_계획_수정본.md` — Revised syllabus with week-by-week breakdown and teaching methodology
- PDFs of weekly lecture slides (Weeks 1–3) are provided externally by the instructor
- `progress_summary.md` — (to be generated) Summary of Weeks 1–3 content
- `game_ideas.md` — (to be generated) Practical game ideas for hands-on sessions
- `game_dev_plan.md` — (to be generated) Practical game development plan
